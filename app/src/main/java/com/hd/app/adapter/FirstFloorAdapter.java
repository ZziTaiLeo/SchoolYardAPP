...
public class FirstFloorAdapter extends BaseAdapter {
    ...
    private String TAG = "FirstLaboratoryAdapter";

    public FirstFloorAdapter(Context context, List<Room> rooms) {

        this.context = context;
        inflater = LayoutInflater.from(context);
        this.rooms = rooms;
        Log.d(TAG, "ROOM SIZE IS " + rooms.size());
    }
