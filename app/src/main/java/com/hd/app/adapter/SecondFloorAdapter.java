 ...
 */
//创建教学楼空教室适配
public class SecondFloorAdapter extends BaseAdapter {
          ...
          private String TAG = "SecondFloorAdapter";

          public SecondFloorAdapter(Context context, List<Room> rooms) {
          ...
          public View getView(int position, View convertView, ViewGroup parent) {
                    ...
                    //TODO可优化
                    System.out.println("position si :"+position);
                    if (position < 5) {
                              room_name = "20" + (position + 1) % 6;
